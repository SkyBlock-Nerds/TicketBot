package net.hypixel.nerdbot.tickets.listener;
...
import net.hypixel.nerdbot.tickets.config.TicketTemplateField;
...
public class TicketListener {
    ...
    private boolean isStaffMember(Member member) {
        ...
        TicketConfig ticketConfig = TicketBot.config().getTicketConfig();
